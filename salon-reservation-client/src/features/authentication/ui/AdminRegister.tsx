...
import { RegisterData, UserRole } from '../model/types';

interface AdminRegisterProps {
  onSuccess: () => void;
}

export const AdminRegister: React.FC<AdminRegisterProps> = ({ onSuccess }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setErrors({ general: '관리자 등록에 실패했습니다.' });
    } finally {
      setLoading(false);
    }
  };
